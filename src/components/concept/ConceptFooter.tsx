      ...
      <div className="mx-auto grid max-w-[1440px] gap-10 px-5 py-14 sm:px-8 lg:grid-cols-12 lg:gap-8 lg:px-10 lg:py-16">
        ...
        <div className="lg:col-span-2">
          ...
          <ul className="mt-4 flex flex-col gap-2.5 text-[0.9375rem] text-ink/70">
            <li>
              <a href="#home" className="transition-colors hover:text-royal">
                Home
              </a>
            </li>
            <li>
              <a href="#about" className="transition-colors hover:text-royal">
                About Us
              </a>
            </li>
            <li>
              <a href="#services" className="transition-colors hover:text-royal">
                Services
              </a>
            </li>
            <li>
              <a href="#pricing" className="transition-colors hover:text-royal">
                Pricing
              </a>
            </li>
            <li>
              <a href="#faq" className="transition-colors hover:text-royal">
                FAQ
              </a>
            </li>
          </ul>
